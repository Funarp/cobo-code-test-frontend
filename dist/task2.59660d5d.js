...
},{}],"js/solve.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.solve_maze = void 0;
var DISABLE_DIR_ZERO = "left";
var DEBUG = true;
...
var solve_maze = function solve_maze(panel) {
  var end_x = panel.length - 1;
  var end_y = panel[end_x].length - 1;
  var current_x = 0,
      current_y = 0; // solve path

  var path = [[current_x, current_y]];
  var panel_copy = JSON.parse(JSON.stringify(panel));
  ...
  while (true) {
    ...
    var current_point = panel_copy[current_x][current_y]; // count avaliable directions

    if (directions_count(current_point) > 0) {
      for (var dir in current_point) {
        if (!current_point[dir]) {
          current_point[dir] = true; // move
...
},{"./maze":"js/maze.js","./panel":"js/panel.js","./solve":"js/solve.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
